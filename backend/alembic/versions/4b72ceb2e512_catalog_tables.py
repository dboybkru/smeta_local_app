...
def upgrade() -> None:
    ...
    sa.CheckConstraint("kind IN ('material', 'work')", name='ck_catalog_items_kind'),
    )
    op.create_index(
    ...
    sa.CheckConstraint('version > 0', name='ck_price_lists_version_positive'),
    )
    op.create_index(
    ...
    op.create_index(
        op.f('ix_item_prices_price_level_id'),
        'item_prices',
        ['price_level_id'],
        unique=False,
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_item_prices_price_level_id'), table_name='item_prices', if_exists=True)
